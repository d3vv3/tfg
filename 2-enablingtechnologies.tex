...
\todi{Escribir pequeña introducción o resumen del capítulo}

\section{Tecnologías en el cliente}
\label{tec_hab:client}

\todi{Escribir pequeña introducción}
...
\todi{Meter algo del lenguaje utilizado en WASM}
